		...
		<div class="ctar-form">
			...
			<div class="psubs">
				<div class="psubs-heading">
					<label><?php echo $lca["label:tbl:nticker"]; ?></label>
				</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select class="form-control _ffe_" name="tbl:nticker:default-page-size">
								<?php CHtmlMacro::printOptions(
									CEnv::config("dtable/search"),
									"page-size-list", $rs["tbl:nticker:default-page-size"]); ?> 
								</select>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select class="form-control _ffe_" name="tbl:nticker:default-sort-val">
								<?php CSortRec::printSortOptions("nticker",
									$rs["tbl:nticker:default-sort-val"]);
								?> 
								</select>
							</div>
						</div>
