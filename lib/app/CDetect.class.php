...
class CDetect {
	...
	public static function isMobile() {
		...
		return (
			preg_match('/(android|bb\d+|meego).+mobile|'.
				'avantgo|bada\/|blackberry|blazer|compal|elaine|'.
				'fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|'.
				'lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|'.
				'phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|'.
				'symbian|treo|up\.(browser|link)|vodafone|wap|'.
				'windows (ce|phone)|xda|xiino/i',$useragent) ||
			preg_match('/1207|6310|6590|3gso|4thp|'.
				'50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|'.
				'ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|'.
				'ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|'.
				...
				'po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|'.
				'60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|'.
